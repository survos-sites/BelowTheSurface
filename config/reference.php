 ...
 *     default_engine?: scalar|null|Param, // Name of the engine to use by default (e.g. "libre_local"). // Default: "libre_local"
 *     cache?: array{
 *         pool?: scalar|null|Param, // CacheItemPoolInterface service id (e.g. "cache.translator"). Leave null to disable caching. // Default: null
 *         ttl?: int|Param, // Default TTL (seconds) for cached translations. 0 = no expiration. // Default: 0
 *     },
 *     engines?: array<string, array{ // Default: []
 *         type: "libre"|"bing"|"deepl"|"google"|Param, // Provider. API key is REQUIRED for deepl/google/bing; optional for libre.
 *         base_uri?: scalar|null|Param, // Optional. If null, sensible defaults are used for deepl/google/bing; for self-hosted LibreTranslate, set your host. // Default: null
 *         api_key?: scalar|null|Param, // Provider API key (use env vars like %env(DEEPL_API_KEY)%). Required for deepl/google/bing; optional for libre. // Default: null
 *         region?: scalar|null|Param, // Some providers (e.g. Bing) require a region (e.g. "global"). // Default: null
